...
//        Profile profile =
        ...
        Set<Like> likes = new HashSet<>(Arrays.asList(like, like1, like2, like3, like4, like5, like6));
        ...
        Set<Comments> comments = new HashSet<>(Arrays.asList(comment, comment1, comment2, comment3));
